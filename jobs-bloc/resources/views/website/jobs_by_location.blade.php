    ...
    <div class="container border-bottom border-2 border-dark mb-4">
        ...
        <div class="container">
         ...
         <div class="row my-3">
            ...
            @for($i=1;$i<=20;$i++)
             <div class="col-12 col-md-3 mb-2">
                 <li><a href="#" class="text-decoration-none text-reset"> <small>Jobs in Bangalore </small>  </a></li>
             </div>
            @endfor
         </div>  
         ...
         <div class="row my-3">
            ...
            @for($i=1;$i<=30;$i++)
             <div class="col-12 col-md-3 mb-2">
                 <li><a href="#" class="text-decoration-none text-reset"> <small>Jobs in Ajmer </small>  </a></li>
             </div>
            @endfor
         </div>  
