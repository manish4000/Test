                  ...
                  <div class="tab-pane my-4" id="education">
                    ...
                    <div class="py-3">
                        <div class="ps-4" style="border-left-style: solid ; padding-left:12px" >
                            ...
                            <div class="row mb-2"> 
                               <span><i class="fa fa-briefcase fa-x mb-1 mr-3 ml-3" aria-hidden="true"></i> <span class="fs-5 fw-bold"> {{$education->ed_title}}  </span>  </span>                      
                              </div>
                    ...
                    @foreach ($resume_awards as $award)
                                ...
                                <div class="py-3 ">
                                    <div class="ps-4"  style="border-left-style: solid ; padding-left:12px">
                                        ...
                                        <div class="row mb-2"> 
                                            <p><span><i class="fa-solid  mx-3  fa-trophy"></i> <span class="fs-5 fw-bold"> {{$award->aw_title}}  </span>  </span>  </p>                   
                                        </div>
